...
<div align="center">
   ...
   <br></br>
    ...
    <p><b>Bagi pengguna Provider ISP <a href="https://www.jsn.net.id/">PT Jaringanku Sarana Nusantara (JSN)</a> dan pengguna ISP lain yang memblokir domain DoH/DoT, silahkan kontak kami di [`dukungan (at) bebasid.com`](mailto:dukungan@bebasid.com) untuk mendapatkan alternatif domain lain untuk mengakses layanan DNS BebasID.</b></p><br>
...
| Protocols       | IP/Domain Addresses                  | DNSCrypt Stamps & Ports                                                                                                                                                                                                                    |  Supported Ports  |
| --------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------------: |
| Plain DNS, IPv6 | `2a06:9f44:f3e0:d01c::6`             | <ins>IPv6 (**Port 53**)</ins>:</br> `sdns://AAMAAAAAAAAAG1syYTA2OjlmNDQ6ZjNlMDpkMDFjOjo2XTo1Mw`,</br> <ins>IPv6 (**Port 1753**)</ins>:</br> `sdns://AAMAAAAAAAAAHVsyYTA2OjlmNDQ6ZjNlMDpkMDFjOjo2XToxNzUz`                                  | `53`,</br> `1753` |
