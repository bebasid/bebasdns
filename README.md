...
| -------- | ------- | :---: |
| DNS, IPv4 | **1:** ``147.139.211.126`` (CGK), **2:** ``47.254.192.66`` (KUL) | **1:** ``53``, ㅤㅤ**2:** ``1753`` | 
| DNS, IPv6 | **1:** ``2001:470:36:9be:ba5::1d`` (SIN), ㅤㅤㅤㅤㅤㅤ**2:** ``2001:470:36:b90:beba:5::1d`` (KUL) | **1:** ``53``, ㅤㅤ**2:** ``1753`` |  
