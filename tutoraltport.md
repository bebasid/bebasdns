...
```
<sup>Telkom & XL menggunakan <i>Transparent DNS Proxy</i> untuk IPv6 nya juga. Pastikan anda menjalankan perintah IPv6 diatas jika anda menggunakan kedua ISP tersebut.</sup>
